			...
			<ul class="menu">
				<li>
					...
					<ul>
						...
						<li><a href="http://www.mylesnicholson.com/dismissal2/reports/allTeacherView.php">All Teacher Report</a></li>
				...
				<li>
					<a href="#">Admin</a>
					<ul>
						<li><a href="http://www.mylesnicholson.com/dismissal2/reports/editData.php">Edit Data</a></li>
						<li><a href="http://www.mylesnicholson.com/dismissal2/reports/importView.php">Import Data</a></li>
